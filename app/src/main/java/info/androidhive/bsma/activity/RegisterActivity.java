 ...
 *
 * this class will proceed the registration
 */
...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!firstname.isEmpty() && !lastname.isEmpty() && !address.isEmpty() && !age.isEmpty() && !phone.isEmpty() && !email.isEmpty() && !password.isEmpty() && !confirm_password.isEmpty()) {
                    if(confirm_password.equals(password)){
                        registerUser(firstname, lastname, age, phone, grade, path, address, sector, email, password);}
     ...
     * */
    private void registerUser(final String firstname, final String lastname, final String age, final String phone,
                              final String grade, final String path, final String address, final String sector, final String email, final String password) {
